...
function NotFound() {
  return (
    <div className=" w-full-screen py-40  flex items-center justify-center">
    <div className=" flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
        <p className="text-white text-6xl md:text-7xl lg:text-9xl font-bold tracking-wider ">404</p>
        ...
        <a href="/clientes" className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150" title="Return Home">
